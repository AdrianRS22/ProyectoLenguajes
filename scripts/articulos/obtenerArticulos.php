...
BEGIN 
    OPEN cursorArticulo FOR SELECT ID_ARTICULO, OBTENERNOMBRECATEGORIA(ID_CATEGORIA) CATEGORIA, NOMBRE, FORMATEARPRECIO(ARTICULO.PRECIO) PRECIO, CODIGO_CABYS  FROM ARTICULO;
