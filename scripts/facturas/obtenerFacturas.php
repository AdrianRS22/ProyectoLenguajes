...
BEGIN 
    OPEN cursorFactura FOR SELECT NUM_FACTURA, OBTENERMODOPAGO(ID_MODOPAGO) MODOPAGO, OBTENERCLIENTEPORID(ID_CLIENTE) NOMBRECLIENTE, IVA, DESCUENTO, FECHA FROM FACTURA;
